...
describe Squad do
  ...
  it {should have_many :facility_fleets}
  ...
  context 'buying and selling facilities' do
    ...
    context 'aggregating profits' do
      ...
      it 'should generate a % of profits when you have air control of a planet' do
        squad.generate_profits!
        squad.credits.should == (planet.credits * (100 - Setting.getInstance.ground_income_rate) / 100)
      end
  ...
  context 'warping units' do
    ...
    context 'like capital ships' do
      before do
        ...
        squad.warp_units 1000, CapitalShip, 400, planet
      end
    ...
    context 'like armaments' do
      it 'should be an armament' do
        light_transport = Factory(:armament)
        squad.warp_units 1000, Armament, 1..200, planet
        squad.fleets.first.generic_unit.should be_a Armament
      end
    end
  end
