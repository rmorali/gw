bespin = Planet.create(:name => 'Bespin', :sector => 1, :x => 650, :y => 450, :description => 'Bespin Cloud City' )
brr_station = Planet.create(:name => 'BrR Station', :sector => 4, :x => 1650, :y => 1050, :credits => 0, :tradeport => true, :description => 'Tradeport' )
cimf_station = Planet.create(:name => 'CIMF Station', :sector => 1, :x => 450, :y => 250, :credits => 0, :tradeport => true, :description => 'Tradeport' )
concord_dawn = Planet.create(:name => 'Concord Dawn', :sector => 2, :x => 1650, :y => 250, :description => 'Raxus Prime' )
corellia = Planet.create(:name => 'Corellia', :sector => 2, :x => 1450, :y => 450, :description => 'Corellia' )
coruscant = Planet.create(:name => 'Coruscant', :sector => 2, :x => 850, :y => 250, :description => 'Coruscant' )
dagobah = Planet.create(:name => 'Dagobah', :sector => 4, :x => 850, :y => 1050, :description => 'Dagobah' )
deathstar = Planet.create(:name => 'Death Star', :sector => 2, :x => 1250, :y => 250, :description => 'Deathstar' )
endor = Planet.create(:name => 'Endor', :sector => 1, :x => 450, :y => 650, :description => 'Kashyyyk' )
felucia = Planet.create(:name => 'Felucia', :sector => 3, :x => 2050, :y => 250, :description => 'Felucia' )
geonosis = Planet.create(:name => 'Geonosis', :sector => 4, :x => 1450, :y => 850, :description => 'Geonosis/R. Prime' )
haruun_kal = Planet.create(:name => 'Haruun Kal', :sector => 4, :x => 1250, :y => 650, :description => 'Haruun Kal' )
hoth = Planet.create(:name => 'Hoth', :sector => 1, :x => 850, :y => 650, :description => 'Hoth/RhenVar Harbor' )
kamino = Planet.create(:name => 'Kamino', :sector => 3, :x => 2450, :y => 650, :description => 'Kamino' )
kashyyyk = Planet.create(:name => 'Kashyyyk', :sector => 3, :x => 2250, :y => 450, :description => 'Kashyyyk' )
kessel_asteroids = Planet.create(:name => 'Kessel Asteroids', :sector => 3, :x => 1850, :y => 450, :description => 'Polis Massa' )
kuat = Planet.create(:name => 'Kuat', :sector => 4, :x => 1650, :y => 650, :description => 'Ord Ibanna' )
mandalore = Planet.create(:name => 'Mandalore', :sector => 2, :x => 1050, :y => 450, :description => 'Yavin Arena' )
mon_calamari = Planet.create(:name => 'Mon Calamari', :sector => 3, :x => 2450, :y => 250, :description => 'Kamino Tipoca City' )
mustafar = Planet.create(:name => 'Mustafar', :sector => 1, :x => 250, :y => 850, :description => 'Mustafar' )
mygeeto = Planet.create(:name => 'Mygeeto', :sector => 2, :x => 1050, :y => 50, :description => 'Mygeeto' )
naboo = Planet.create(:name => 'Naboo', :sector => 4, :x => 1050, :y => 850, :description => 'Naboo' )
nal_hutta = Planet.create(:name => 'Nal Hutta', :sector => 3, :x => 2050, :y => 650, :description => 'Jabba Palace' )
ord_ibanna = Planet.create(:name => 'Ord Ibanna', :sector => 1, :x => 650, :y => 850, :description => 'Ord Ibanna' )
polis_massa = Planet.create(:name => 'Polis Massa', :sector => 1, :x => 50, :y => 650, :description => 'Polis Massa' )
rattatak = Planet.create(:name => 'Rattatak', :sector => 1, :x => 250, :y => 450, :description => 'Rattatak' )
res_station = Planet.create(:name => 'RES Station', :sector => 3, :x => 2650, :y => 450, :credits => 0, :tradeport => true, :description => 'Tradeport' )
rhen_var = Planet.create(:name => 'Rhen Var', :sector => 3, :x => 1850, :y => 50, :description => 'Rhen Var Citadel' )
tatooine = Planet.create(:name => 'Tatooine', :sector => 4, :x => 1850, :y => 850, :description => 'Mos Eisley' )
utapau = Planet.create(:name => 'Utapau', :sector => 4, :x => 1250, :y => 1050, :description => 'Utapau' )
yavin = Planet.create(:name => 'Yavin', :sector => 2, :x => 1450, :y => 50, :description => 'Yavin 4' )
