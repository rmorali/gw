...
#Goal.create(:description => 'Dominar, com fabrica e troopers, os planetas Endor, DeathStar, Kashyyk e Geonosis')
#Goal.create(:description => 'Dominar, com fabrica e troopers, os planetas Polis Massa, Coruscant, Kessel Asteroids e Naboo')
#Goal.create(:description => 'Dominar, com fabrica e troopers, os planetas Hoth, Concord Dawn, Kamino e Tatooine')
#Goal.create(:description => 'Dominar, com fabrica e troopers, os 4 planetas com Income Especial')
#Goal.create(:description => 'Dominar, com pelo menos 2000 troopers em cada, a CIMF, BRR e RES Stations')
#Goal.create(:description => 'Dominar, mesmo que parcialmente no ar ou terra, o Quadrante Norte e o planeta Mon Calamari')
