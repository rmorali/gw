...
brr_station = Planet.create(:name => 'BrR Station', :sector => 4, :x => 925, :y => 1150, :credits => 0, :tradeport => true, :description => 'Tradeport' )
cimf_station = Planet.create(:name => 'CIMF Station', :sector => 1, :x => 250, :y => 250, :credits => 0, :tradeport => true, :description => 'Tradeport' )
...
res_station = Planet.create(:name => 'RES Station', :sector => 3, :x => 1488, :y => 475, :credits => 0, :tradeport => true, :description => 'Tradeport' )
