bespin = Planet.create(:name => 'Bespin', :sector => 1, :x => 550, :y => 700, :description => 'Bespin Cloud City' )
brr_station = Planet.create(:name => 'BrR Station', :sector => 4, :x => 1300, :y => 1600, :credits => 0, :tradeport => true, :description => 'Tradeport' )
cimf_station = Planet.create(:name => 'CIMF Station', :sector => 1, :x => 400, :y => 400, :credits => 0, :tradeport => true, :description => 'Tradeport' )
concord_dawn = Planet.create(:name => 'Concord Dawn', :sector => 2, :x => 1300, :y => 400, :description => 'Raxus Prime' )
corellia = Planet.create(:name => 'Corellia', :sector => 2, :x => 1150, :y => 700, :description => 'Corellia' )
coruscant = Planet.create(:name => 'Coruscant', :sector => 2, :x => 700, :y => 400, :description => 'Coruscant' )
dagobah = Planet.create(:name => 'Dagobah', :sector => 4, :x => 700, :y => 1600, :description => 'Dagobah' )
deathstar = Planet.create(:name => 'Death Star', :sector => 2, :x => 1000, :y => 400, :description => 'Deathstar' )
endor = Planet.create(:name => 'Endor', :sector => 1, :x => 400, :y => 1000, :description => 'Kashyyyk' )
felucia = Planet.create(:name => 'Felucia', :sector => 3, :x => 1600, :y => 400, :description => 'Felucia' )
geonosis = Planet.create(:name => 'Geonosis', :sector => 4, :x => 1150, :y => 1300, :description => 'Geonosis/R. Prime' )
haruun_kal = Planet.create(:name => 'Haruun Kal', :sector => 4, :x => 1000, :y => 1000, :description => 'Haruun Kal' )
hoth = Planet.create(:name => 'Hoth', :sector => 1, :x => 700, :y => 1000, :description => 'Hoth/RhenVar Harbor' )
kamino = Planet.create(:name => 'Kamino', :sector => 3, :x => 1900, :y => 1000, :description => 'Kamino' )
kashyyyk = Planet.create(:name => 'Kashyyyk', :sector => 3, :x => 1750, :y => 700, :description => 'Kashyyyk' )
kessel_asteroids = Planet.create(:name => 'Kessel Asteroids', :sector => 3, :x => 1450, :y => 700, :description => 'Polis Massa' )
kuat = Planet.create(:name => 'Kuat', :sector => 4, :x => 1300, :y => 1000, :description => 'Ord Ibanna' )
mandalore = Planet.create(:name => 'Mandalore', :sector => 2, :x => 850, :y => 700, :description => 'Yavin Arena' )
mon_calamari = Planet.create(:name => 'Mon Calamari', :sector => 3, :x => 1900, :y => 400, :description => 'Kamino Tipoca City' )
mustafar = Planet.create(:name => 'Mustafar', :sector => 1, :x => 250, :y => 1300, :description => 'Mustafar' )
mygeeto = Planet.create(:name => 'Mygeeto', :sector => 2, :x => 850, :y => 100, :description => 'Mygeeto' )
naboo = Planet.create(:name => 'Naboo', :sector => 4, :x => 850, :y => 1300, :description => 'Naboo' )
nal_hutta = Planet.create(:name => 'Nal Hutta', :sector => 3, :x => 1600, :y => 1000, :description => 'Jabba Palace' )
ord_ibanna = Planet.create(:name => 'Ord Ibanna', :sector => 1, :x => 550, :y => 1300, :description => 'Ord Ibanna' )
polis_massa = Planet.create(:name => 'Polis Massa', :sector => 1, :x => 100, :y => 1000, :description => 'Polis Massa' )
rattatak = Planet.create(:name => 'Rattatak', :sector => 1, :x => 250, :y => 700, :description => 'Rattatak' )
res_station = Planet.create(:name => 'RES Station', :sector => 3, :x => 2050, :y => 700, :credits => 0, :tradeport => true, :description => 'Tradeport' )
rhen_var = Planet.create(:name => 'Rhen Var', :sector => 3, :x => 1450, :y => 100, :description => 'Rhen Var Citadel' )
tatooine = Planet.create(:name => 'Tatooine', :sector => 4, :x => 1450, :y => 1300, :description => 'Mos Eisley' )
utapau = Planet.create(:name => 'Utapau', :sector => 4, :x => 1000, :y => 1600, :description => 'Utapau' )
yavin = Planet.create(:name => 'Yavin', :sector => 2, :x => 1150, :y => 100, :description => 'Yavin 4' )
